const addBikeShelter = () => {
  const id = "bike-shelters";
  const data = "https://data.cityofnewyork.us/resource/dimy-qyej.geojson";
  ...
  map.on("click", id, el => {
    ...
    const address = el.features[0].properties.location;
